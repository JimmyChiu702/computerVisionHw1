...
for epoch in tqdm(range(opt.epoch, opt.n_epochs)):
    for i, batch in tqdm(enumerate(dataloader)):
        ...
        loss_GAN_B2A = criterion_GAN(pred_fake, target_real.unsqueeze(0))
        ...
        loss_D_real = criterion_GAN(pred_real, target_real.unsqueeze(0))

        # Fake loss
        fake_A = fake_A_buffer.push_and_pop(fake_A)
        pred_fake = netD_A(fake_A.detach())
        loss_D_fake = criterion_GAN(pred_fake, target_fake.unsqueeze(0))
